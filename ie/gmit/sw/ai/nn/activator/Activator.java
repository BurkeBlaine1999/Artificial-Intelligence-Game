...
public interface Activator {
	...
	/* The activation function for a neuron can be any continuous function. 
	 * A multi-layer back-propagation network uses sigmoidal or hyperbolic
	 ...
	 * 
	 *    e(p) = (Yd(P) - Y(p)) * slope
	 *    error(interation p) = (desired output(p) - actual output(p) * slope)
	 *    
	 *    big error = big adjustment
	 *    small error = small adjustment
	 *    try get as close to 0
	 *
